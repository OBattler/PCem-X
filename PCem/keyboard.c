...
static scancode scancode_set2[272] =
{
        ...
        { {-1},             {-1} },                   { {-1},             {-1} },                   { {0xe0, 0x12, -1}, {0xe0, 0xF0, 0x12, -1} }, { {-1},             {-1} },                                      /*a8*/
        ...
        { {0xe0, 0x49, -1}, {0xe0, 0xF0, 0x49, -1} }, { {0xe0, 0x4A, -1}, {0xe0, 0xF0, 0x4A, -1} }, { {0xe0, 0x59, -1}, {0xe0, 0xF0, 0x59, -1} }, { {0xe0, 0x7C, -1}, {0xe0, 0xF0, 0x7C, -1} },                    /*b4*/
        ...
        { {0xe0, 0x09, -1}, {0xe0, 0xF0, 0x09, -1} }, { {-1},             {-1} },                   { {0xe0, 0x7E, -1}, {0xe0, 0xF0, 0x7E, -1} }, { {0xe0, 0x6C, -1}, {0xe0, 0xF0, 0x6C, -1} },                    /*c4*/
        { {0xe0, 0x75, -1}, {0xe0, 0xF0, 0x75, -1} }, { {0xe0, 0x7D, -1}, {0xe0, 0xF0, 0x7D, -1} }, { {-1},             {-1} },                   { {0xe0, 0x6B, -1}, {0xe0, 0xF0, 0x6B, -1} },                    /*c8*/
        { {0xe0, 0x73, -1}, {0xe0, 0xF0, 0x73, -1} }, { {0xe0, 0x74, -1}, {0xe0, 0xF0, 0x74, -1} }, { {0xe0, 0x79, -1}, {0xe0, 0xF0, 0x79, -1} }, { {0xe0, 0x69, -1}, {0xe0, 0xF0, 0x69, -1} },                    /*cc*/
        { {0xe0, 0x72, -1}, {0xe0, 0xF0, 0x72, -1} }, { {0xe0, 0x7A, -1}, {0xe0, 0xF0, 0x7A, -1} }, { {0xe0, 0x70, -1}, {0xe0, 0xF0, 0x70, -1} }, { {0xe0, 0x71, -1}, {0xe0, 0xF0, 0x71, -1} },                    /*d0*/
        ...
        { {0xe0, 0x68, -1}, {0xe0, 0xF0, 0x68, -1} }, { {0xe0, 0x6A, -1}, {0xe0, 0xF0, 0x6A, -1} }, { {0xe0, 0x6D, -1}, {0xe0, 0xF0, 0x6D, -1} }, { {0xe1, 0x14, 0x77, 0xe1, 0xF0, 0x14, 0xF0, 0x77, -1}, {-1} },  /*fc*/
...
static scancode scancode_set3[272] =
{
        ...
        { {0xe0, 0x1A, -1}, {0xe0, 0xF0, 0x1A, -1} }, { {0xe0, 0x22, -1}, {0xe0, 0xF0, 0x22, -1} }, { {0xe0, 0x21, -1}, {0xe0, 0xF0, 0x21, -1} }, { {0xe0, 0x2A, -1}, {0xe0, 0xF0, 0x2A, -1} },  /*ac*/
        { {0xe0, 0x32, -1}, {0xe0, 0xF0, 0x32, -1} }, { {0xe0, 0x31, -1}, {0xe0, 0xF0, 0x31, -1} }, { {0xe0, 0x3A, -1}, {0xe0, 0xF0, 0x3A, -1} }, { {-1},             {-1} },                    /*b0*/
        { {0xe0, 0x49, -1}, {0xe0, 0xF0, 0x49, -1} }, { {0x77, -1},       {0xF0, 0x77, -1} },       { {0xe0, 0x59, -1}, {0xe0, 0xF0, 0x59, -1} }, { {0x57, -1},       {0xF0, 0x57, -1} },        /*b4*/
        ...
        { {0x60, -1},       {0xe0, 0x60, -1} },       { {0x6D, -1},       {0xF0, 0x6D, -1} },       { {0x67, -1},       {0xF0, 0x67, -1} },       { {0x64, -1},       {0xF0, 0x64, -1} },        /*d0*/
        { {0xd4, -1},       {0xF0, 0xD4, -1} },       { {0xe0, 0x60, -1}, {0xe0, 0xF0, 0x60, -1} }, { {-1},             {-1} },                   { {0xe0, 0x78, -1}, {0xe0, 0xF0, 0x78, -1} },  /*d4*/
        ...
        { {0xe0, 0x53, -1}, {0xe0, 0xF0, 0x53, -1} }, { {0xe0, 0x5C, -1}, {0xe0, 0xF0, 0x5C, -1} }, { {-1},             {-1} },                   { {0xe0, 0x62, -1}, {0xe0, 0xF0, 0x62, -1} },  /*f4*/
        { {0xe0, 0x63, -1}, {0xe0, 0xF0, 0x63, -1} }, { {0xe0, 0x64, -1}, {0xe0, 0xF0, 0x64, -1} }, { {0xe0, 0x65, -1}, {0xe0, 0xF0, 0x65, -1} }, { {0xe0, 0x67, -1}, {0xe0, 0xF0, 0x67, -1} },  /*f8*/
        { {0xe0, 0x68, -1}, {0xe0, 0xF0, 0x68, -1} }, { {0xe0, 0x6A, -1}, {0xe0, 0xF0, 0x6A, -1} }, { {0xe0, 0x6D, -1}, {0xe0, 0xF0, 0x6D, -1} }, { {0x62, 0xF0, 0x62, -1}, {-1} },               /*fc*/
...
void keyboard_process()
{
	...
	else
	{
        ...
        for (c = 0; c < 272; c++)
        {
			...
			if (AT && ((mode & 3) == 3))
			{
				if (!set3_all_break && !pcem_key[c] && !(set3_flags[scancodes[c].scancodes_make[0]] & 2))
					continue;
			}
//                        pclog("Key %02X start\n", c);
                        d = 0;
		...
		if (AT && ((mode & 3) == 3))
		{
			if (scancodes[c].scancodes_make[0] == -1)
				continue;
			if (!set3_all_repeat && !pcem_key[c] && !(set3_flags[scancodes[c].scancodes_make[0]] & 1))
				continue;
		}
                if (keydelay[c] >= 30)
                {
