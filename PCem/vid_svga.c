...
void svga_setscan(svga_t *svga, int val)
{
	svga->crtc[9] = (svga->crtc[9] & 0xE0);
	svga->crtc[9] |= (val & 0x1F);
}

int svga_getscan(svga_t *svga)
{
...
void svga_recalctimings(svga_t *svga)
{
	...
	svga->htotal += 5; /*according to my data, +5 is correct*/
